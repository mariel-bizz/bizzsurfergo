    ...
    <Sheet open={open} onOpenChange={setOpen}>
      <SheetTrigger asChild>
        <button
          ...
          className="fixed z-40 right-4 bottom-24 w-14 h-14 rounded-full bg-gradient-agentic-shift shadow-elegant flex items-center justify-center hover:scale-105 active:scale-95 shadow-2xl"
        >
