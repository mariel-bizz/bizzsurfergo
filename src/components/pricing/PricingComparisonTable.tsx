...
const ROWS: Row[] = [
  ...
  { label: "Event Registrations", values: { go: "1 / year", hero: "2 / month", champion: "Unlimited", team: "Unlimited" } },
  ...
  { label: "Premium AI (Claude, Gemini, OpenAI, Mistral, Perplexity)", values: { go: false, hero: false, champion: true, team: true } },
